...
Setup is done. Now pick a track below — **AWS**, **GCP**, or **both** (in any order). Each file is complete on its own and includes its own sign-in, deployment, and teardown.
